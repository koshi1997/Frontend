...
export class SignupComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.signupForm = this.formBuilder.group({
      name: [null, [Validators.required, Validators.pattern(GlobleConstants.nameRegex)]],
      email: [null, [Validators.required, Validators.pattern(GlobleConstants.emailRegex)]],
      contactNumber: [null,[Validators.required, Validators.pattern(GlobleConstants.contactNumberRegex)]],
